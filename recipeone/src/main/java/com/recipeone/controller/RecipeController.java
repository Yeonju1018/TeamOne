...
public class RecipeController {
	...
	//public static int pageSize = 10; // 한 페이지에 보여줄 레코드 수
	...
	public String recipeList(HttpSession session, Model model, @RequestParam(value = "currentPage", defaultValue = "1") int currentPage) {
		...
		// 페이징을 위한 서브리스트 생성
/*		List<ListRecipeDto> sublist = null;
		sublist = listRecipeDtoList.subList(startIndex, endIndex);*/
